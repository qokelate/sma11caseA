...
char *const kBinaryNumberKeys = BinaryNumberKeys;
char *const kOctalNumberKeys = OctalNumberKeys;
char *const kDecimalNumberKeys = DecimalNumberKeys;
char *const kHexUpperCaseKeys = HexUpperCaseKeys;
char *const kHexLowerCaseKeys = HexLowerCaseKeys;
char *const kLowerCaseKeys = LowerCaseKeys;
char *const kUpperCaseKeys = UpperCaseKeys;
